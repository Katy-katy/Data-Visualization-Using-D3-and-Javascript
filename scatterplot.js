    ...
    var xScale = d3.scale.linear().domain([0,16]).range([0, width]);
    //var xMap = function(d) { return xScale(xValue(d));};
    var xAxis = d3.svg.axis().scale(xScale).orient("bottom").tickPadding(2);

    var yValue = function(d) { return d.epc;};
    var yScale = d3.scale.linear().domain([-10,400]).range([height, 0]);
   ...
   //x-axis
    ...
    //Draw Scatterplot
        ...
        .on("mouseover", function(d) {
            ...
            .duration(200)
            .style("opacity", .9);
         tooltip.html("" + d.country + "<br>" + "Population: " + d.population + " Million" + "<br>" + "GDP: " + d.gdp + " Trillion" + "<br>" + "EPS: " + d.epc + "Million BTus" + "<br>" + "Total: " + d.total + " Trillion BTUs")
